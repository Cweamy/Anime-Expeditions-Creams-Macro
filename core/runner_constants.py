...
__all__ = [
    # Recovery / retry budgets
    "BACK_SPAM_MAX_CLICKS", "BACK_SPAM_DELAY", "BACK_SPAM_CHECK_TIMEOUT",
    "MAP_SELECT_RETRY_ATTEMPTS", "TASK_RECOVERY_ATTEMPTS",
    "MAX_CONSECUTIVE_LOSSES_SAME_MAP",
    # Lobby / gamemode navigation
    "STORY_CLICK", "LOBBY_CHECK_TIMEOUT", "STORY_SCREEN_TIMEOUT",
    "BACK_CONFIRM_TIMEOUT", "GAMEMODE_CLICK_TIMEOUT",
    "PLAY_CLICK_RETRY_ATTEMPTS",
    # Start Game
    "START_GAME_CLICK_RETRY_ATTEMPTS", "START_GAME_CLICK_VERIFY_SETTLE",
    "START_GAME_BUTTON_WAIT_TIMEOUT",
    # Expedition wave/checkpoint
    "EXPEDITION_WAVE_TIMEOUT", "EXPEDITION_EXTRACT_CONFIRM_TIMEOUT",
    "EXTRACT_CONFIRM_SETTLE", "EXPEDITION_CONTINUE_COOLDOWN",
    "EXP_COLOR_CONTINUE_BAND", "EXP_COLOR_CONFIRM_BAND",
    "EXP_COLOR_FOLLOWUP_BAND", "EXP_COLOR_MIRROR_MARGIN",
    "EXP_COLOR_CONTINUE_MIN_RUN", "EXP_COLOR_CONFIRM_MIN_RUN",
    "EXP_COLOR_FOLLOWUP_MIN_RUN", "EXP_COLOR_SIGHTING_DEBOUNCE",
    "EXP_COLOR_CONTINUE_SETTLE",
    # Stage select
    "STAGE_SCREEN_TIMEOUT", "STAGE_ORDER", "STAGE_CLICK_BASE",
    "STAGE_ROW_HEIGHT", "ACT_ORDER", "ACT_CLICK_BASE", "ACT_ROW_HEIGHT",
    # Event
    "EVENT_ACT_ORDER", "EVENT_ACT_IMAGES", "EVENT_ACT_SCROLL_FROM_INDEX",
    "EVENT_SCREEN_TIMEOUT", "DROP_RELIC_IMAGE", "VILLIAN4_CLOSE_IMAGE",
    "EVENT_ACT4_STAGE",
    # Difficulty / special stages
    "SPECIAL_STAGES_NO_DIFFICULTY",
    "EXPEDITION_MAP_IMAGES", "EXPEDITION_DIFFICULTY_CLICK",
    "EXPEDITION_DIFFICULTY_CLICK_DELAY", "DIFFICULTY_CLICK_DELAY",
    # Challenge
    "CHALLENGE_STORY_MAPS", "CHALLENGE_STAGE_SLOTS",
    "CHALLENGE_STAGE_CLICK", "CHALLENGE_SCREEN_TIMEOUT",
    "CHALLENGE_MAP_DETECT_TIMEOUT",
    # Matchmaking / teleport
    "RETURN_TO_LOBBY_CHECK_TIMEOUT", "MATCHMAKING_WAIT_TIMEOUT",
    "SOLO_START_TIMEOUT", "TELEPORT_IN_TIMEOUT",
    "MATCHMAKING_TELEPORT_TIMEOUT", "SOLO_START_RETRY_ATTEMPTS",
    "SOLO_TELEPORT_PER_ATTEMPT_TIMEOUT", "TELEPORT_STUCK_TIMEOUT",
    "TELEPORT_POLL_INTERVAL", "RECONNECT_IMAGE_NAMES",
    # Image name tuples
    "NAV_PLAY_IMAGE_NAMES", "EXPEDITION_IMAGE_NAMES",
    "CHALLENGE_IMAGE_NAMES", "RAID_IMAGE_NAMES", "STORY_IMAGE_NAMES",
    "NAV_START_IMAGE_NAMES", "NAV_DISBAND_IMAGE_NAMES",
    "PRIORITY_UPGRADE_IMAGE_NAMES",
    # Deep link / URLs
    "PLACE_ID", "REJOIN_DEEPLINK",
    "DISCORD_INVITE_URL", "GITHUB_REPO_URL", "YOUTUBE_URL",
    "REJOIN_TIMEOUT", "REJOIN_POLL_INTERVAL",
    # Start Game / UI navigation
    "START_GAME_CHECK_TIMEOUT", "NAV_CLICK_TIMEOUT",
    "REPEAT_STAGE_MODAL_CLEAR_TIMEOUT", "REWARD_CARD_CLEAR_TIMEOUT",
    "RESULT_CAPTURE_DELAY", "SETTLE_DELAY",
    "WARNING_WAIT_TIMEOUT", "WARNING_POLL_INTERVAL",
    # Place Unit
    "PLACE_VALID_PIXEL_TOLERANCE", "PLACE_SEARCH_BOX_SIZE",
    "PLACE_PIXEL_SEARCH_SETTLE", "PLACE_SEARCH_WIGGLE_OFFSETS",
    "PLACE_SEARCH_WIGGLE_TIMEOUT", "PLACE_SPIRAL_RADII",
    "PLACE_SPIRAL_MARGIN", "PLACE_SPIRAL_TIMEOUT",
    "PLACE_HOTKEY_SETTLE", "PLACE_UNIT_CLICK_SETTLE",
    "PLACE_UNIT_VERIFY_TIMEOUT", "PLACE_UNIT_VERIFY_ATTEMPTS",
    "PLACE_RETRY_UNTIL_PLACED_ATTEMPTS", "MAX_PLACEMENT_THRESHOLD",
    "UNIT_INFO_RESET_CLICK", "SCREEN_MIDDLE_CLICK",
    # Battle blocks
    "BATTLE_BLOCK_CLICK_SETTLE", "UPGRADE_RETRY_WAIT",
    "UPGRADE_PANEL_LOAD_TIMEOUT",
    # Auto Upgrade
    "AUTO_UPGRADE_PRIORITY_ROW_HEIGHT_MULT",
    "AUTO_UPGRADE_PRIORITY_FIRST_ROW_MULT",
    "AUTO_UPGRADE_PRIORITY_X_OFFSET_MULT", "AUTO_UPGRADE_CLICK_SETTLE",
    # Team Loadout
    "TEAM_PANEL_TIMEOUT", "TEAM_LOADOUT_CONFIRM_RETRY_ATTEMPTS",
    "TEAM_LOADOUT_CONFIRM_SETTLE", "TEAM_LOADOUT_CLICK_1",
    "TEAM_LOADOUT_ROW_HEIGHT", "TEAM_LOADOUT_MAX_SUPPORTED",
    "TEAM_LOADOUT_SCROLL_ANCHOR", "TEAM_LOADOUT_SCROLL_SMALL",
    "TEAM_LOADOUT_SCROLL_LARGE", "TEAM_LOADOUT_SLOT_7_Y",
    "TEAM_LOADOUT_SLOT_8_Y", "TEAM_LOADOUT_SCROLL_SETTLE",
    # Wave / match result
    "WAVE_REGION", "WAIT_WAVE_POLL_INTERVAL",
    "DEFAULT_COORDS", "MATCH_RESULT_TIMEOUT", "MATCH_RESULT_POLL_INTERVAL",
]
